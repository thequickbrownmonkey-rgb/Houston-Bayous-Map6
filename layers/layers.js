...
//ol.proj.get("EPSG:4326").setExtent([-96.005732, 29.371000, -94.832993, 30.781641]);
var wms_layers = [];
...
var lyr_SurfaceWaterQualityMonitoringStations_5 = new ol.layer.Vector({
    ...
    <img src="styles/legend/SurfaceWaterQualityMonitoringStations_5_3.png" /> LAKE<br />\
    <img src="styles/legend/SurfaceWaterQualityMonitoringStations_5_4.png" /> PIPE<br />\
    <img src="styles/legend/SurfaceWaterQualityMonitoringStations_5_5.png" /> POND<br />\
    <img src="styles/legend/SurfaceWaterQualityMonitoringStations_5_6.png" /> RESERV<br />\
    <img src="styles/legend/SurfaceWaterQualityMonitoringStations_5_7.png" /> STREAM<br />\
    <img src="styles/legend/SurfaceWaterQualityMonitoringStations_5_8.png" /> TDLSTR<br />' });
...
var format_LandmarksPointsofInterest_7 = new ol.format.GeoJSON();
var features_LandmarksPointsofInterest_7 = format_LandmarksPointsofInterest_7.readFeatures(json_LandmarksPointsofInterest_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_LandmarksPointsofInterest_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_LandmarksPointsofInterest_7.addFeatures(features_LandmarksPointsofInterest_7);
var lyr_LandmarksPointsofInterest_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_LandmarksPointsofInterest_7, 
                style: style_LandmarksPointsofInterest_7,
                popuplayertitle: 'Landmarks / Points of Interest',
                interactive: true,
                title: '<img src="styles/legend/LandmarksPointsofInterest_7.png" /> Landmarks / Points of Interest'
            });

lyr_BaseMap_0.setVisible(true);lyr_Watersheds_1.setVisible(true);lyr_Waterways_2.setVisible(true);lyr_GREENWAYS_3.setVisible(true);lyr_BikeRoutes_4.setVisible(true);lyr_SurfaceWaterQualityMonitoringStations_5.setVisible(true);lyr_CommunityCenters_6.setVisible(true);lyr_LandmarksPointsofInterest_7.setVisible(true);
var layersList = [lyr_BaseMap_0,lyr_Watersheds_1,lyr_Waterways_2,lyr_GREENWAYS_3,lyr_BikeRoutes_4,lyr_SurfaceWaterQualityMonitoringStations_5,lyr_CommunityCenters_6,lyr_LandmarksPointsofInterest_7];
...
lyr_LandmarksPointsofInterest_7.set('fieldAliases', {'X': 'X', 'Y': 'Y', 'Name': 'Name', 'Year': 'Year', 'Description': 'Description', 'url': 'url', });
...
lyr_SurfaceWaterQualityMonitoringStations_5.set('fieldImages', {'OBJECTID': 'TextEdit', 'Station_ID': 'TextEdit', 'Short_Desc': 'TextEdit', 'Long_Desc': 'TextEdit', 'Basin_ID': 'TextEdit', 'Segment_ID': 'TextEdit', 'StreamType': 'TextEdit', 'StreamCond': 'TextEdit', 'OnSegFlag': 'TextEdit', 'County_ID': 'TextEdit', 'County': 'TextEdit', 'TCEQRegion': 'TextEdit', 'USGS_GID': 'TextEdit', 'USGS_NHDID': 'TextEdit', 'Latitude': 'TextEdit', 'Longitude': 'TextEdit', 'URL': 'TextEdit', 'Collecting': 'TextEdit', 'FY': 'TextEdit', 'Active_Ind': 'TextEdit', });
...
lyr_LandmarksPointsofInterest_7.set('fieldImages', {'X': 'TextEdit', 'Y': 'TextEdit', 'Name': 'TextEdit', 'Year': 'TextEdit', 'Description': 'TextEdit', 'url': 'TextEdit', });
...
lyr_LandmarksPointsofInterest_7.set('fieldLabels', {'X': 'hidden field', 'Y': 'hidden field', 'Name': 'no label', 'Year': 'no label', 'Description': 'no label', 'url': 'no label', });
lyr_LandmarksPointsofInterest_7.on('precompose', function(evt) {
