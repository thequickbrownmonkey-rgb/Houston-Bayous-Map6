...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            //extent: [-96.005732, 29.371000, -94.832993, 30.781641],
            units: 'degrees'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-96.005732, 29.371000, -94.832993, 30.781641], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_LandmarksPointsofInterest_7,
    colName: 'Name',
    zoom: 10,
    collapsed: true,
    map: map,
